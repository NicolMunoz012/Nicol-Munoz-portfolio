    ...
    academic: [
      {
        ...
        description: "Ongoing cybersecurity course focused on women in tech.",
      },
      {
        period: "Jan 2026 – Present",
        title: "Samsung Innovation Campus – AI & Employability",
        place: "Samsung",
        description: "Ongoing program divided into two modules: Artificial Intelligence and Employability.",
      },
      {
        period: "Oct 2025",
        title: "Third National Software Engineering Seminar",
        place: "Pasto, Colombia",
        description: "8-hour seminar held on October 17, 2025 in Pasto, Colombia.",
      },
      {
        period: "May 2025",
        title: "Second National Software Engineering Seminar",
        place: "Pasto, Colombia",
        description: "8-hour seminar held on May 28, 2025 in Pasto, Colombia.",
      },
      {
        period: "2024 – Present",
        title: "Software Engineering",
        place: "Universidad Cooperativa de Colombia (UCC), Pasto Campus",
        description: "Currently enrolled in the Software Engineering program.",
      },
      {
        period: "Aug 2024",
        title: "Programming Challenge: Java",
        place: "LinkedIn",
        description: "Course completed on August 21, 2024.",
      },
      {
        period: "May 2024",
        title: "Project Management Fundamentals: Requirements",
        place: "LinkedIn",
        description: "Course completed on May 4, 2024.",
      },
      {
        period: "2019 – 2023",
        ...
        description: "Technical education combining preventive vehicle maintenance with fundamentals of database analysis and management.",
      },
    ],
    work: [
      {
