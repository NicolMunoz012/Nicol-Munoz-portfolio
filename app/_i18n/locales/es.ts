    ...
    academic: [
      {
        ...
        description: "Curso de ciberseguridad en curso, orientado a mujeres en tecnología.",
      },
      {
        period: "Ene 2026 – Presente",
        title: "Samsung Innovation Campus – IA & Empleabilidad",
        place: "Samsung",
        description: "Programa en curso dividido en dos módulos: Inteligencia Artificial y Empleabilidad.",
      },
      {
        period: "Oct 2025",
        title: "Tercer Seminario Nacional de Ingeniería de Software",
        place: "Pasto, Colombia",
        description: "Seminario de 8 horas llevado a cabo el 17 de octubre de 2025 en la ciudad de Pasto.",
      },
      {
        period: "May 2025",
        title: "Segundo Seminario Nacional de Ingeniería de Software",
        place: "Pasto, Colombia",
        description: "Seminario de 8 horas llevado a cabo el 28 de mayo de 2025 en la ciudad de Pasto.",
      },
      {
        period: "2024 – Presente",
        title: "Ingeniería de Software",
        place: "Universidad Cooperativa de Colombia (UCC), Campus Pasto",
        description: "Actualmente cursando el programa de Ingeniería de Software.",
      },
      {
        period: "Ago 2024",
        title: "Desafío de Programación: Java",
        place: "LinkedIn",
        description: "Curso completado el 21 de agosto de 2024.",
      },
      {
        period: "May 2024",
        title: "Fundamentos de la Gestión de Proyectos: Requisitos",
        place: "LinkedIn",
        description: "Curso completado el 4 de mayo de 2024.",
      },
      {
        period: "2019 – 2023",
        ...
        description: "Formación técnica que combinó el mantenimiento preventivo de vehículos automotores con fundamentos de análisis y gestión de bases de datos.",
      },
    ],
    work: [
      {
